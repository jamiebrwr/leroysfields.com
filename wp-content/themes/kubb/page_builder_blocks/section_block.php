...
class AQ_Section_Block extends AQ_Block {
	...
	function form($instance) {
		...
		$type_options = array(
			...
			'black-wrapper' => 'Standard (Black-Wrapper)',
...
<?php
	...
	function block_callback($instance) {
		...
		if(isset($template_id)) {
			...
			if( $type == 'image' ){
				echo '<div class="parallax" style="background-image: url('. $image .');"><div class="container inner"><div class="row">';
			} else {
				echo '<div class="' . $type . '"><div class="container inner"><div class="row">';
			}
