...
function srh_remove_menu_pages() {
    ...
    function srh_check_username() {
        ...
        if( $user && isset( $user->user_login ) && 'jamie' !== $user->user_login ) {
            ...
            remove_menu_page( 'wp_scroll_posts_setting'  );
            /* Sub Menus */
			...
			remove_submenu_page( 'edit.php?post_type=photos', 'ce-photos-column-editor');
			remove_submenu_page( 'edit.php?post_type=internships', 'ce-internships-column-editor');
			remove_submenu_page( 'edit.php?post_type=subsidiaries', 'ce-subsidiaries-column-editor');
			remove_submenu_page( 'edit.php?post_type=businesses', 'ce-businesses-column-editor');
			remove_submenu_page( 'edit.php?post_type=real_estate', 'ce-real_estate-column-editor');
			remove_submenu_page( 'edit.php?post_type=job_oppertunities', 'ce-job_oppertunities-column-editor');
			remove_submenu_page( 'edit.php?post_type=people', 'ce-people-column-editor');
			remove_submenu_page( 'edit.php?post_type=tribe_events', 'ce-tribe_events-column-editor');
...
function remove_dashboard_widgets(){
    ...
    remove_meta_box('tribe_dashboard_widget', '', 'normal');   // Other WordPress News
...
function hide_plugin_srhtrick() {
  ...
  $hidearr = array(
		...
		'wp-scroll-posts/wp-scroll-posts.php',
