...
function ebor_load_scripts() {
	...
	wp_enqueue_script( 'ebor-dangerous', get_template_directory_uri() . '/style/js/idangerous.swiper-2.1.min.js', array('jquery'), false, true  );
	...
	wp_enqueue_script( 'ebor-instafeed', get_template_directory_uri() . '/style/js/instafeed.min.js', array('jquery'), false, true  );
	wp_enqueue_script( 'ebor-flickr', get_template_directory_uri() . '/style/js/jquery.dcflickr.1.0.js', array('jquery'), false, true  );
	if ( is_ssl() ) {
	...
	wp_enqueue_script( 'ebor-classie', get_template_directory_uri() . '/style/js/classie.js', array('jquery'), false, true  );
