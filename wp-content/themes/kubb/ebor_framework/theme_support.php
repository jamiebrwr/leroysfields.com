...
function ebor_starter_add_editor_styles() {
    ...
    /**
     * Remove post type support from portfolio
     */
...
function ebor_starter_add_theme_support() {
	 ...
	 */
	add_image_size( 'index', 440, 270, true);
	add_image_size( 'portfolio', 400, 290, true);
	add_image_size( 'portfolio-carousel', 9999, 550, false);
	add_image_size( 'portfolio-carousel-leader', 400, 550, true);
	add_image_size( 'masonry', 440, 9999, false);
	 ...
	 */
	load_theme_textdomain('kubb', get_template_directory() . '/languages');
