...
class AQ_Blog_Block extends AQ_Block {
	...
	function form($instance) {
		...
		$blog_types = array(
			...
			'blogclassicnosidebar' => 'Classic Blog Feed',
			'blogclassic' => 'Classic Blog Feed & Sidebar'
		);
	?>
	...
	?>
					...
					<div class="row blog-posts grid-blog">
						...
						<?php 
							if ( $blog_query->have_posts() ) : while ( $blog_query->have_posts() ) : $blog_query->the_post();
								 ...
								 * Get blog posts by blog layout.
								 */
								get_template_part('loop/content', 'post2col');
		...
		<?php elseif( $type == 'blogclassicnosidebar' ) : ?>
