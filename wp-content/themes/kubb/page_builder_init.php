...
if(class_exists('AQ_Page_Builder')) {
	...
	if(!( class_exists('AQ_Icon_Column_Alt_Block') )){
		require_once ( "page_builder_blocks/icon_block_alt.php" );
		aq_register_block('AQ_Icon_Column_Alt_Block');
	}
	...
	if(!( class_exists('AQ_Portfolio_Preview_Block') )){
		require_once ( "page_builder_blocks/portfolio_preview_block.php" );
		aq_register_block('AQ_Portfolio_Preview_Block'); 
	}
	...
	if(!( class_exists('AQ_Portfolio_Post_Carousel_Block') )){
		require_once ( "page_builder_blocks/portfolio_post_carousel_block.php" );
		aq_register_block('AQ_Portfolio_Post_Carousel_Block');
	}
	...
	if(!( class_exists('AQ_Flickr_Block') )){
		require_once ( "page_builder_blocks/flickr_block.php" );
		aq_register_block('AQ_Flickr_Block');
	}
	if(!( class_exists('AQ_Polaroid_Block') )){
		require_once ( "page_builder_blocks/polaroid_block.php" );
		aq_register_block('AQ_Polaroid_Block');
	}
	if(!( class_exists('AQ_Sharing_Buttons_Block') )){
		require_once ( "page_builder_blocks/sharing_buttons_block.php" );
		aq_register_block('AQ_Sharing_Buttons_Block');
	}
